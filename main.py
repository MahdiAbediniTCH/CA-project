...
lru_total = {
    'cassandra':[[908734, 906999, 910822, 914362, 913148, 914030],
             [908828, 917420, 911221, 915926, 916965, 917827]],
    'streaming':[[110408, 110432, 112161, 111859, 111777, 111248],
                 [111748, 111240, 111594, 112019, 111193, 111108]]
}
lru_hits = {
    'cassandra':[[333933, 377982, 404945, 388625, 381830, 372830],
            [513752, 601363, 677387, 719518, 769128, 787084]],
    'streaming':[[34461, 40769, 46196, 47924, 49193 ,49466],
...
mru_total = {
    'cassandra':[[908734, 906881, 906466, 902278, 903278, 904663],
             [908828, 906408, 906527, 905069, 906831, 903887]],
    'streaming':[[110408, 110927, 109470, 110701, 108572, 109133],
                 [111748, 110904, 110131, 109604, 110106, 109820]]
}
mru_hits = {
    'cassandra':[[333933, 175589, 76755, 35725, 23659, 23808],
            [513752, 356320, 198648, 97458, 57709, 45965]],
    'streaming':[[34461, 28158, 21990, 19414, 18054, 18483],
...
rnd_total = {
    'cassandra':[[908734, 913414, 908313, 917302, 908155, 914375],
             [908828, 911764, 913137, 907978, 910833, 910349]],
    'streaming':[[110408, 111121, 110892, 110302, 111516, 111104],
                 [111748, 110514, 111110, 111413, 111114, 110566]]
}
rnd_hits = {
    'cassandra':[[333933, 272893, 219997, 249732, 275722, 305093],
            [513752, 442817, 388167, 338410, 335635, 349719]],
    'streaming':[[34461, 37798, 40746, 43599, 47653, 49710],
...
# news
lfu_total = {
    'cassandra':[[908734, 909169, 915280, 914677, 911049, 914786],
             [908828,910525, 912061, 915302, 913983, 919720]],
    'streaming':[[110408, 109934, 111045, 110984, 111147, 111201],
                 [111748, 111499, 110817, 111947, 112220, 111187]]
}
lfu_hits = {
    'cassandra':[[333933, 344520, 347428, 331705, 343497, 332935],
            [513752,553065, 519921, 487110, 463114, 461360]],
    'streaming':[[34461, 46005, 50793, 52789, 52558, 51089],
...
arc_total = {
    'cassandra':[[908734, 912275, 912457, 909465, 915206, 909375],
             [908828, 912119, 917139, 912933, 916304, 913884]],
    'streaming':[[110408, 110676, 111358, 111380, 111419, 111377],
                 [111748, 111017, 111709, 112420, 112044, 112499]]
}
arc_hits = {
    'cassandra':[[333933, 367906, 396050, 393808, 386649, 371980],
            [513752, 598444, 674025, 730489, 742449, 779597]],
    'streaming':[[34461, 41650, 44950, 47562, 48933, 49560],
...
srp_total = {
    'cassandra':[[908734, 918095, 909507, 920645, 909504, 908604],
             [908828, 911160, 910642, 918049, 913803, 918648]],
    'streaming':[[110408, 111609, 111098, 111428, 111719, 111185],
                 [111748, 110721, 111621, 112067, 112190, 111006]]
}
srp_hits = {
    'cassandra':[[333933, 462749, 505550, 509860, 403013, 316307],
            [513752, 635480, 703086, 723737, 651188, 514264]],
    'streaming':[[34461, 46866, 51956, 54173, 53626, 51146],
...
tplru_total = {
    'cassandra':[[908734, 906999, 908675, 911509, 917828, 908429],
               [908828, 917420, 912628, 915228, 916226, 916152]],
    'streaming':[[110408, 110432, 111348, 112069, 110853, 112456],
                 [111748, 111240, 111477, 112198, 111981, 111615]]
}
tplru_hits = {
    'cassandra':[[333933, 377982, 395818, 412203, 407160, 392977],
              [513752, 601363, 657653, 714504, 752319, 768190]],
    'streaming':[[34461, 40769, 45492, 47509, 47799, 49806],
...
larc_total = {
    'cassandra':[[904624, 912981, 914278, 909632, 912998, 911702],
               [902515, 910911, 912691, 914384, 912221, 915184]],
    'streaming':[[110577, 110633, 112066, 111726, 111681, 112010],
                 [109255, 112146, 111897, 111698, 111725, 110966]]
}
larc_hits = {
    'cassandra':[[28871, 497100, 534799, 529527, 545348, 543906],
              [59106, 658600, 721007, 756475, 780913, 798007]],
    'streaming':[[26800, 50228, 55338, 56356, 57166, 57908],
...
plt.ylabel("Hit Rate (%)")
plt.title("Cache Replacement Policies ( " + str(2 ** (cache_size + 1)) + " MB CACHE SIZE"+" - "+'Trace: '+trace+" )")
plt.legend()
